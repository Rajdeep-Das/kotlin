...
public class TranslationContext {
    ...
    public void addDeclarationStatement(@NotNull JsStatement statement) {
        if (inlineFunctionContext != null) {
            CallableDescriptor containingInlineFunction = inlineFunctionContext.getDescriptor();
            if (!containingInlineFunction.getVisibility().effectiveVisibility(containingInlineFunction, true).getPublicApi()) {
